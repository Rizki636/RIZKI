...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @rizki_ridho636`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @rizki_ridho636`)
})
...
conn.sendMessage(id, 'Owner rizky https://wa.me/087840411119' ,MessageType.text);
}
else if (text == 'Aris'){
